...
import ChooseAddressModal from "./component/chooseAddress";
          ...
          <Row className="space-x-2 flex items-center">
            ...
            <Col flex={1}>
              <Row justify={"space-between"} align="middle">
                ...
                <input
                  //name={`basic_info.brand`}
                  // className="w-full px-2 py-1 bg-transparent appearance-none border-2 border-gray-500 rounded-[6px] focus:outline-none focus:bg-white focus:border-blue-400"
